...
const ATMAppHeader = (props: Props) => {
  ...
  const className =
    "flex items-center justify-between h-full px-4 border-b bg-gray-50";
  return (
    <div className={className}>
      <div className="flex items-center gap-4">
        <button
          ...
          className={`text-primary-dark ${
            isNavBarExpanded && "text-primary-darker"
          }`}
        >
          <IconMenu2 />
        </button>
      ...
      <div className="relative">
        <div
          ...
          className="size-[30px] bg-primary flex justify-center items-center text-white font-medium rounded-full text-xs capitalize cursor-pointer"
        >
          {userData?.name?.[0]}
        </div>
