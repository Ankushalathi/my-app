...
const ATMTableHeaderCell = ({
  ...
  const className = {
    headerCell: `flex gap-1 items-center min-w-[100px] px-4 font-semibold tracking-wide  transition-all duration-300 text-xs text-primary uppercase ${flex} ${getPaddingY(
      density
